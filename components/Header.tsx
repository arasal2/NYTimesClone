...
const Header = () => {
    return (
        ...
        <nav className="bg-gray-50">
            <div className="max-w-7xl mx-auto px-1 sm:px-1 lg:px-1 flow-root">
                <div className="flex items-start py-2 justify-between gap-6 h-8 ">
                    <div className="flex flex-row flex-shrink-0 gap-6 py-1">
                    ...
                    <div style={{ fontSize: "10px", marginLeft: '12rem' }} className="hidden md:block text-sm  ">
                    ...
                    <div className="hidden md:block  flex items-center">
                        <button style={{ fontFamily:"helvetica", backgroundColor: "rgb(86, 123, 149)", border: "1px solid rgb(86, 123, 149)", fontSize:"0.75rem" }} className="text-white font-bold rounded border-dark-100 px-3  ml-4 pt-1 pb-1">
                ...
                <div className="flex items-center my-1 justify-center gap-6 h-16">
                ...
                <hr></hr>
                <div className=' border-double border-black border-b-4 flex justify-center'>

                    <div style={{ fontFamily: "helvetica", fontSize:"0.75rem"}} className='ml-4 py-2 flex items-center gap-4 '>
                        <a href="/section/world">World</a>
                        <a href="/section/us">U.S.</a>
                        <a href="/section/politics">Politics</a>
                        <a href="/section/nyregion">N.Y.</a>
                        ...
                        <a href="/section/style">Style</a>
                        <a href="/section/food">Food</a>
                        <a href="/section/travel">Travel</a>
                        <a href="/section/magazine">Magazine</a>
                        <a href="/section/realestate">Real Estate</a>

                        <a className='border-l-2 border-grey pl-2' href="https://cooking.nytimes.com/">Cooking</a>
                        <a href="https://theathletic.com/">The Athletic</a>
                        <a href="https://www.nytimes.com/wirecutter/">Wirecutter</a><a href="https://www.nytimes.com/crosswords">Games</a>
                    </div>
                </div>
            </div>
        </nav>
